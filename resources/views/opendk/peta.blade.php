...
@section('content_header')
    <h1>Online Pengguna OpenDK<small class="font-weight-light ml-1 text-md font-weight-">Pengguna aktif dalam 7 hari terakhir @if($provinsi = session('provinsi')) {{ "| {$provinsi->nama_prov}" }} @endif</small>
    </h1>
@stop
