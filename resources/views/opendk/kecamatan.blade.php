...
@section('content_header')
    <h1>Kecamatan OpenDK<small class="font-weight-light ml-1 text-md font-weight-">(Kecamatan yang memasang OpenDK ) @if($provinsi = session('provinsi')) {{ "| {$provinsi->nama_prov}" }} @endif</small></h1>
@stop
